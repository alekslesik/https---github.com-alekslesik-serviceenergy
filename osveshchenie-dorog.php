...
<div class="ceo-wrap-grey">
    <div class="ceo-container">
        <div class="ceo-flex-elem">
            <h4>Интеллектуальный подход</h4>
            <p>Технология позволяет настраивать схемы освещения в зависимости от времени года или суток. Учитывать трафик, атмосферные явления, активность пешеходного трафика.</p>
            <p>Система Spot Light позволяет оптимизировать освещение для конкретных участков дороги. Различные схемы освещения снижают риск создания условий для ДТП из-за плохой видимости. В итоге, повышается безопасность транспортного трафика.</p>
            <p>Технология IoT для города предлагает большие возможности. Можно дистанционно управлять одним или группой светодиодных фонарей. Например, менять интенсивность освещения. Программно задавать время включения и продолжительность работы.</p>
        </div>
        <div class="ceo-flex-elem">
            <div>
                <img style="margin: 0px !important;" width="100%" src="/local/templates/aspro-allcorp3_energy/images/osveshen_dorog.png" style="border-radius:5px;">
            </div>
        </div>
        <div class="ceo-flex-elem" style="width: 100%;">
            <h4>Экономия без потери эффективности</h4>
            <p>Диммирование светодиодных светильников позволяет эффективно использовать электроэнергию. Датчики движения могут включать или отключать светильники, менять яркость. В совокупности достигается снижение расхода электроэнергии до 60%.</p>
            <p>АСУНО Spot Light может работать в автоматическом режиме. Встроенная система самодиагностики позволяет оперативно сообщать о возникших проблемах. Контроллеры могут эффективно управлять светильниками даже при обрыве связи с ШУНО.</p>
            <p>Все светильники способны ретранслировать сигнал, передавая данные о возникшей проблеме определённом участке. Суммарно снижается нагрузка на операторов и техников. В итоге достигается уменьшение затрат на обслуживание до 50%.</p>
        </div>
    </div>
...
<div class="ceo-wrap-white">
    <h2>Основные звенья Spot Light</h2>
    <div class="ceo-container">
        <div class="ceo-flex-elem">

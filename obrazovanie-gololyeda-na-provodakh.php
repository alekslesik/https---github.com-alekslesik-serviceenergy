...
<h2 style="text-align:center;">Обледенение проводов</h2>
<div style="background-color: #f6f6f6; padding: 20px 20px 20px 20px; border-radius:5px;">
    ...
    <div style="background-color: #1074bc; padding: 20px 20px 20px 20px; border-radius:5px;">
        <h4 style="text-align:center; color: #fff; border-radius: 1px;">Снег налип на провод и понизил температуру провода, угла стрелы провеса и амплитуду вибрации от погодных явлений</h4>
        <div class="ceo-container">
            <div class="ceo-images">
                <img width="100%" src="/local/templates/aspro-allcorp3_energy/components/aspro/33.png" style="border-radius:5px;">
            </div>
            <div class="ceo-images">
                <img width="100%" src="/local/templates/aspro-allcorp3_energy/components/aspro/43.png" style="border-radius:5px;">
            </div>
        </div>
    </div>

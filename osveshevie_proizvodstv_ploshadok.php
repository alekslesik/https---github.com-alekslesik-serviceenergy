...
<div class="ceo-wrap-grey">
    <div class="ceo-container">
        <div class="ceo-flex-elem">
            <h5>Преимущества АСУНО «Спот Лайт»</h5>
            <p>
                Работу «Спот Лайт» можно оценить на примере освещения производственных площадок. При установке, и эксплуатации системы достигается ряд позиций:
            </p>
            <ul>
                <li>
                    &mdash; до 60% экономии электричества
                </li>
                <li>
                    &mdash; до 50% сокращения расходов на сервис
                </li>
                <li>
                    &mdash; высокая скорость реагирования на сигналы
                </li>
                <li>
                    &mdash; эффективное и качественное обслуживание пространства
                </li>
            </ul>

            <p> Система Spot Light обеспечивает умное освещение производственных площадок. Это возможность управления дистанционно. Схема связи при этом проста: контроллер + WiFi + компьютер + программа. В итоге программа контролирует весь процесс.
            </p>
            <p> Регулирование яркости и расхода электроэнергии достигается обычной настройкой параметров в программе. Так же Spot Light позволяет предупредить, увидеть и устранить сбой. Оперативный мониторинг сети максимально снижает расходы на обслуживание.
            </p>
        </div>
        <div class="ceo-flex-elem">
            <div>

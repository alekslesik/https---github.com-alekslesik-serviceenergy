    ...
    <div style="background-color: #1074bc; padding: 20px 20px 20px 20px; border-radius:5px; color: #fff;">
        ...
        <div class="ceo-container">
            <div class="ceo-images">
                <img width="100%" src="/local/templates/aspro-allcorp3_energy/components/aspro/1.png" style="border-radius:5px;">
                <p>Зафиксировано 5 отключений за 2 месяца наблюдений</p>
            </div>
            <div class="ceo-images">
                <img width="100%" src="/local/templates/aspro-allcorp3_energy/components/aspro/2.png" style="border-radius:5px;">
                <p>Зафиксировано отключение линии на 2 часа 20.09.2019 с 16-00 до 18-20</p>
            </div>
        </div>
    </div>
